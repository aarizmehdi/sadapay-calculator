...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col">
      {/* Spline 3D Background — z-index 0 */}
      <SplineBackground
        sceneUrl={undefined}
        fallbackColor="#072333"
      />

      {/* Content layer — z-index 1, sits above the 3D background */}
      <div className="relative z-10 flex flex-col flex-1">
        {/* Top bar — semi-transparent navy */}
        <header className="bg-sadapay-navy/80 backdrop-blur-sm text-white py-3 px-6">
        ...
        {/* Footer — semi-transparent navy */}
        <footer className="bg-sadapay-navy/60 backdrop-blur-sm text-white/40 py-4 px-6">
