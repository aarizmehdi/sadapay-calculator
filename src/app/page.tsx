...
import FloatingCurrencyBg from "@/components/FloatingCurrencyBg";

export default function Home() {
  return (
    <div className="relative min-h-screen">
      {/* 3D Floating Currency Background */}
      <FloatingCurrencyBg />
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Footer */}
        <footer className="bg-sadapay-navy/80 backdrop-blur-sm text-white/40 py-4 px-6">
